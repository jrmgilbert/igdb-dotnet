...
namespace IGDB
{
  ...
  public sealed class IGDBClient
  {
    ...
    {
      [Obsolete("Use AgeRatings instead", error: false)]
      public const string AgeRating = "age_ratings";

      public const string AgeRatings = "age_ratings";

      [Obsolete("Use AgeRatingCategories instead", error: false)]
      public const string AgeRatingCategory = "age_rating_categories";

      public const string AgeRatingCategories = "age_rating_categories";

      [Obsolete("Use AgeRatingContentDescriptionsV2 instead", error: false)]
      ...
      public const string CollectionMemberships = "collection_memberships";

      public const string CollectionMembershipTypes = "collection_membership_types";
      ...
      public const string CompanyStatuses = "company_statuses";
      ...
      [Obsolete("Use Franchises instead", error: false)]
      ...
      public const string ReleaseDateStatuses = "release_date_statuses";
